export function Service() {
  return (
    <>
      <section
        id="service"
        className="w-full h-auto bg-neutral-800 py-20 flex flex-col items-center"
      >
        <div className="w-[328px] md:w-[960px] flex-col gap-16 md:gap-20 flex">
          <div className="flex-col justify-start items-center gap-10 flex">
            <div className="flex-col items-center flex">
              ...
              <h3 className="text-lime-300 text-base font-bold font-['Noto Sans JP'] leading-normal tracking-wide">
                事業内容
              </h3>
            </div>
            <p className="md:w-[640px] text-zinc-100 text-base font-medium font-['Noto Sans JP'] leading-normal tracking-wide">
          ...
          <div className="flex-col justify-start items-start gap-10 flex">
            ...
            <div className="flex flex-col gap-10 md:gap-16">
              <div className="grid md:grid-cols-2 flex-col gap-2 md:gap-6">
                <h3 className="md:order-2 text-white text-2xl font-bold font-['Noto Sans JP'] leading-9 tracking-wide">
                  ITスクール
                  <br />
                  RareTECH
                </h3>
                <div className="md:order-1 w-[328px] md:w-[400px] h-[185px] md:h-[225px] bg-raretech bg-cover rounded-2xl row-span-3" />
                <p className="md:order-3 text-zinc-100 text-base font-medium font-['Noto Sans JP'] leading-normal tracking-wide mb-4">
              ...
              <div className="grid md:grid-cols-2 flex-col gap-2 md:gap-6">
                <h3 className="text-white text-2xl font-bold font-['Noto Sans JP'] leading-9 tracking-wide">
                  インフラ学習サービス
                  <br />
                  エンベーダー
                </h3>
                <div className="w-[328px] md:w-[400px] h-[185px] md:h-[225px] bg-envader bg-cover rounded-2xl row-span-3 justify-self-end" />
                <p className="text-zinc-100 text-base font-medium font-['Noto Sans JP'] leading-normal tracking-wide mb-4">
