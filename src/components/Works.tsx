export function Works() {
  return (
    <>
      <section className="font-sans w-full h-auto py-20 bg-zinc-800 justify-center gap-2.5 flex">
        <div className="w-[328px] md:w-[1280px] flex flex-col items-center">
            ...
            <div className="flex-col md:flex-row gap-10 md:gap-6 flex pb-10">
              <div className="flex-col gap-2 md:gap-4 flex">
                ...
                <div className="flex-col gap-1 flex">
                  <p className="text-white text-sm font-bold leading-[21px] tracking-wide">
                    2023.08.17
                  </p>
