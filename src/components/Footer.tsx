...
export function Footer() {
  return (
    <>
      <footer className="font-sans w-full pt-20 pb-6 bg-neutral-800 flex-col justify-start items-center gap-2.5 flex">
        <div className="w-[328px] md:w-[1280px] flex-col items-center gap-10 flex">
          <div className="w-full flex-col md:flex-row justify-start md:justify-between gap-10 flex">
            <address className="flex flex-col gap-2">
              ...
              />
              <p className="text-white text-xl font-bold leading-[30px] tracking-wide">
                株式会社var
              </p>
              <p className="text-zinc-100 text-sm font-medium leading-[21px] tracking-wide">
                〒 891-0145
                <br />
                鹿児島県鹿児島市錦江台3-21-22
              </p>
            ...
            <div className="flex-col gap-6 flex">
              <div className="flex flex-col md:flex-row items-start gap-4 md:gap-10">
                <nav className="flex-col justify-center gap-2 flex">
                  <h2 className="text-zinc-100 text-base font-bold leading-normal tracking-wide">
                    サービス
                  </h2>
                  <Link
